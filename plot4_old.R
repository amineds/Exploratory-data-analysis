...
nei_coal <- NEI[NEI$SCC %in% SCC[grep("Coal", SCC$EI.Sector), 1], ]
...
png("plot444.png", height=720, width=720)
message("device open")
...
g <- g + labs(title = "Total PM2.5 emissions from coal combustion-related sources per EI Sector in US") 
